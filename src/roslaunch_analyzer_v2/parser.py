...
def _parse_entity_tree(
    entity: launch.LaunchDescriptionEntity, context: launch.LaunchContext
):
    ...
    if isinstance(entity, launch_ros.actions.Node):
        ...
        entity._Node__node_executable = _to_string(
    ...
    if isinstance(entity, launch_ros.actions.LoadComposableNodes):
        ...
        return EntityTree(entity=entity, children=nodes)

    if sub_entities is None:
        return EntityTree(entity=entity, children=[])
    ...
    return EntityTree(entity=entity, children=children)
